...
FORBIDDEN_CAPABILITIES: set[str] = {
    ...
    "pc-server.file.delete", "pc-server.file.bulk_delete", "pc-server.file.read_secret",
    "pc-server.system.write_config", "pc-server.system.run_shell", "pc-server.input.type_password",
    "pc-server.input.click_payment_button", "pc-server.system.modify_policy",
