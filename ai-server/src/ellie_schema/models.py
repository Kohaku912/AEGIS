"""Pydantic models for Ellie's shared capability protocol.

These models are the Python runtime representation of the protobuf schema
defined in protos/ellie/common.proto and protos/ellie/capability.proto.
