...
val AegisAction = Color(0xFF3D8BFF)
val AegisMemory = Color(0xFFA66CFF)
val AegisCommunication = Color(0xFFFF7AA8)
val AegisInfrastructure = Color(0xFF31C7B5)
val AegisPolicy = Color(0xFFFFB84D)
